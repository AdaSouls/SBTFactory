...
contract SBT is ERC4973 {
    ...
    constructor(string memory _name, string memory _symbol) ERC4973(_name, _symbol, "1") {
        owner = msg.sender;
    }

    function issue(address _beneficiary, string calldata _uri) external onlyOwner {
        _mint(msg.sender, _beneficiary, count, _uri);
        count += 1;
    }
